...
export default function ProdSupportTab() {
  return (
    <div className="flex flex-col items-center justify-center min-h-[40vh] gap-4 text-center">
      <div className="w-14 h-14 rounded-2xl bg-[#134C93]/10 flex items-center justify-center">
        <Headset size={28} className="text-[#134C93]" />
      </div>
      <div>
        <h2 className="text-lg font-bold text-[#141A2B]">Prod Support</h2>
        <p className="text-sm text-[#6E7791] mt-1 max-w-xs">
          Production support ticket volumes, SLA compliance, and escalation trends will appear here.
        </p>
      </div>
